...
export const UPLOADING_METADATA_DESC = "Uploading metadata. Please wait it may take some time to complete the process";
export const UPLOADING_IMAGE = "Uploading Image";
export const UPLOADING_IMAGE_DESC = "Uploading NFT image to IPFS. Please wait it may take some time to complete the process";